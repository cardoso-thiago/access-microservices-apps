...
import br.com.mastertech.door.model.Error;
import br.com.mastertech.door.model.builder.ErrorBuilder;
...
public class RestExceptionHandler {
    @ExceptionHandler(value = {DoorSystemException.class})
    protected ResponseEntity<Object> handleDoorSystemException(DoorSystemException e) {
